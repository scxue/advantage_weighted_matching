...
export BASE_DIR="/opt/tiger/helloworld"

# Project root directory
export PROJECT_ROOT="${BASE_DIR}"

# Miniconda installation path
export CONDA_PATH="/home/tiger/miniconda3"
...
# ------------------------------
# pip build / cache directories
# ------------------------------
export TMPDIR="/opt/tiger/pip_tmp"
export PIP_CACHE_DIR="/opt/tiger/pip_cache"
