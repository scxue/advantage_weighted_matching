...
@click.option('--precond',       help='Preconditioning & loss function', metavar='vp|ve|edm',       type=click.Choice(['vp', 've', 'edm', 'edm_x_s']), default='edm', show_default=True)
...
def main(**kwargs):
    ...
    elif opts.precond == 'edm_x_s':
        c.network_kwargs.class_name = 'training.networks.EDMPrecond'
        c.loss_kwargs.class_name = 'training.loss.EDMLoss_x_s'
    else:
