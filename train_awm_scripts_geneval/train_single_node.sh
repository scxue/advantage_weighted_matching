...
(
  ...
  accelerate launch \
    --config_file "${PROJECT_ROOT}/advantage_weighted_matching/scripts/accelerate_configs/multi_gpu.yaml" \
    --num_processes=8 \
    --main_process_port 29503 \
    "${PROJECT_ROOT}/advantage_weighted_matching/scripts/train_sd3_awm.py" \
    --config "${PROJECT_ROOT}/advantage_weighted_matching/config/dgx_awm.py:geneval_sd3_no_cfg_1node"
