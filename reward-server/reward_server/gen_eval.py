...
DEVICE = "cuda"
MY_CONFIG_PATH="/opt/tiger/helloworld/reward-server/mmdetection/configs/mask2former/mask2former_swin-s-p4-w7-224_lsj_8x2_50e_coco.py"
MY_CKPT_PATH="/opt/tiger/helloworld/reward-server"
